...
- 暂时取消在更新时删除旧版本文件, 以避免删除 AvZ 插件

## [0.7.6] 2026/02/12

- 修复扩展在更改为 ES 模块后无法在旧版本 VSCode 运行的问题

## [0.7.5] 2026/02/07

- 修复命令 `AvZ: Get AvZ Info` 在 AvZ 更新后仍显示旧版本号的问题
- 在自动生成的 clang-format 配置文件中添加 DSL 格式化修复项
